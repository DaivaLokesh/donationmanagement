...
def viewdonars(request):
    ...
    count=Donar.objects.count()
    #auname = request.session["auname"]
    return render(request,"viewdonars.html",{"donardata":donar,"count":count})
...
def viewusers(request):
    ...
    count = User.objects.count()
    #auname = request.session["auname"]
    return render(request,"viewusers.html",{"userdata":users,"count":count})
...
def admindonar(request):
    #auname = request.session["auname"]
    return render(request,"admindonar.html")
...
def addDonar(request):
    ...
    if request.method=="POST":
        ...
        if form1.is_valid():
           ...
           # return HttpResponse("Donar added successfully")
            message="Donar added Successfully"
            return render(request,"adddonar.html",{"msg":message})
        else:
            message="Fail to add Student"
            return render(request, "adddonar.html", {"msg": message})
